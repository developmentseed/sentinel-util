# -*- coding: utf-8 -*-
#Custom version of homura that pretty prints the downloading message
...
class Homura(object):
    ...
    def __init__(self, url, path=None, headers=None, session=None,
        ...
        :param _final_progress_params: the final progress output
        """
        ...
        self.downloaded = 0
        self.auth = None
        self._final_progress_params = None
        if session:
